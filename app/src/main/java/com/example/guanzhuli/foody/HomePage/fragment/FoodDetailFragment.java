    ...
    private void setButtonListener(){
        mButtonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View layout = inflater.inflate(R.layout.dialog_set_add_number,(ViewGroup) view.findViewById(R.id.dialog_number));
                new AlertDialog.Builder(getActivity())
                        .setTitle("Please Input Number")
                        .setIcon(android.R.drawable.ic_dialog_info).setView(layout)
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Dialog dialog = (Dialog) dialogInterface;
                        EditText inputNumber = (EditText) dialog.findViewById(R.id.dialog_et_add_number);
                        ...
                        try{
                            ...
                            new AlertDialog.Builder(getActivity()).setTitle("Successful!").setIcon(
                                    ...
                                    .setMessage("Add " + number + " of " + food.getName() + " to cart!")
