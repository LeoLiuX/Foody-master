...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener{
    ...
    private void getLocationInfo(LatLng latLng){
        ...
        final String baseUrlLatLng = "http://maps.google.com/maps/api/geocode/json?latlng=";
        String curURL = baseUrlLatLng + lat + "," + lng;
        Log.e("GETLOCATIONINFO", curURL.toString());
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, curURL, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                Log.d("MAPS", jsonObject.toString());

                try{
                    String location = jsonObject.getJSONArray("results")
                            .getJSONObject(0)
                            .getString("formatted_address");
                    Log.e("LOCATION", "String: " + location);
